...
class AddCustomerClass:
    ...
    Click_Newsletter_Xpath =("/html/body/div[3]/div[1]/form/section/div/div/nop-cards/nop-card/div/div[2]/div[9]/div["
                             "2]/div/div[1]/div/div")
    Click_Newsletter_list_Xpath = "//li[normalize-space()='Your store name']"
