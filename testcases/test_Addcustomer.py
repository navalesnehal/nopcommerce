...
from PageObjects.AddCustomer import AddCustomerClass
...
class Test_Add_Customer:
    ...
    def test_addCustomer_003(self, setup):
        ...
        if self.ac.Validate_Success_Message() == "pass":
            ...
            self.driver.save_screenshot("C:\\Users\\SHREE\\PycharmProjects\\Nopcom_python\\Screenshots"
                                        "\\test_verify_url_001_pass.png")
            assert True
        else:
            self.driver.save_screenshot("C:\\Users\\SHREE\\PycharmProjects\\Nopcom_python\\Screenshots"
                                        "\\test_verify_url_001_fail.png")
