    ...
    def test_user_login_params_004(self, setup, DataForLogin):
        ...
        if self.lp.Verify_Login_Status() == "Login Pass":  # actual Result # login hogaya
            ...
            if DataForLogin[2] == "Pass":  # expected result
                ...
                self.driver.save_screenshot("C:\\Users\\SHREE\\PycharmProjects\\NopCommerce_python\\Screenshots\\test_user_login_params_004_pass.png")
                ...
                allure.attach(self.driver.get_screenshot_as_png(), name="test_user_login_params_004-Fail",
                              attachment_type=AttachmentType.PNG)
                self.driver.save_screenshot("C:\\Users\\SHREE\\PycharmProjects\\NopCommerce_python\\Screenshots\\test_user_login_params_004_fail.png")
